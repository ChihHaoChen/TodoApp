...
//        }
    ...
    func loadItems(with request: NSFetchRequest<Item> = Item.fetchRequest(), predicate: NSPredicate? = nil)    { //setting default value for the argument of request
